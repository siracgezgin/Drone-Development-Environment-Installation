...
if __name__ == "__main__":
    ...
    print("1")
    drone = connect_drone('udp:127.0.0.1:14550')
    ...
    if drone:
        ...
        print("Took off")
        # 10 meter south
        (t_lat, t_lon) = calculate_target_gps(center_lat, center_lon, 10, "south")
        goto_position(drone, t_lat, t_lon, center_alt)
        print("Reached destination")

        print_gps_coordinates(drone)    
        
    # Repeat for other drones (drone2, drone3) as needed
